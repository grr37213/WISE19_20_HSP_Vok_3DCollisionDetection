...
Im Folgenden wird Die Urquelle \cite{gjk} gibt den Algorithmus im mathematischen Kontext an. Die Umwandlung der Mathematik in eine gute Maschinenimplementierung wird nicht als trivial eingeschätzt. Es fehlen die nötigen Erfahrungswerte mit dem Algorithmus. Es wird daher weiteres Quellmaterial mit praktischem Fokus zu Rate gezogen, um die Implementierung umzusetzen \cite{gjk-casey}.
